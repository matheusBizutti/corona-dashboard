...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    this.setInfosCOVID19(false);
  }

  public getCOVID19Infos(filter = false): Observable<any> {

    return !filter ? this.http.get('https://covid19.mathdro.id/api') :
      this.http.get(`https://covid19.mathdro.id/api/countries/${this.selectedCountry}`);
  }

  public setInfosCOVID19(filter = false) {
